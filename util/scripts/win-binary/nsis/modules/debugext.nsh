...
Section "Visual Studio 2003" DEBUGEXT_SEC02
  push $0
...
Section "Visual Studio 2002" DEBUGEXT_SEC03
  push $0
...
Section "Visual C++ 6.0" DEBUGEXT_SEC04
  push $0
...
Section -PostDebugExtSection
  ...
  CreateShortCut "$SMPROGRAMS\$STARTMENU_STRING\Debugger Extension Readme.lnk" "$INSTDIR\debugext\usage.rtf"
...
Function DoUpdateDatFile
  exch $0 ;dir
  SetOutPath $0
  File "${MODULE_DEBUGEXT_ROOT}\Qt4EEAddin.dll"
  push "$0autoexp.dat"
...
nextline:
  ...
  strcpy $7 $3 12
  strcmp $7 "[AutoExpand]" insert copyline
  copyline:
    FileWrite $5 $3
    goto nextline
