...
enum {
    ...
    CMD_ENDIF, CMD_ENDLINK, CMD_ENDLIST, CMD_ENDOMIT, CMD_ENDPART, CMD_ENDQUOTATION, CMD_ENDRAW,
		       ...
		       const Set<QString>& metaCommandSet )
{
	...
	if ( ch == '\\' ) {
		...
		case UNKNOWN_COMMAND:
			...
			priv->metaCommandMap[commandStr].append(getMetaCommandArgument(commandStr));
