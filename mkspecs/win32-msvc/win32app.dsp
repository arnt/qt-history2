...
# ADD BSC32 /nologo
LINK32=link.exe
# ADD LINK32 $$MSVCDSP_LIBS $$MSVCDSP_VERSION $$MSVCDSP_TARGET $$MSVCDSP_LFLAGS $$QMAKE_LFLAGS_RELEASE "$(IntDir)\$$PRECOMPILED_OBJECT"
...
# ADD BSC32 /nologo
LINK32=link.exe
# ADD LINK32 $$MSVCDSP_LIBS $$MSVCDSP_VERSION $$MSVCDSP_TARGET $$MSVCDSP_LFLAGS /pdbtype:sept $$QMAKE_LFLAGS_DEBUG "$(IntDir)\$$PRECOMPILED_OBJECT"
