...
*/
QDBusAbstractInterface::QDBusAbstractInterface(const QDBusConnection &con, const QString &service,
                                               const QString &path, const char *interface,
                                               QObject *parent)
    : QObject(*new QDBusAbstractInterfacePrivate(con, service, path,
                                                 QString::fromLatin1(interface), false), parent)
{
}
