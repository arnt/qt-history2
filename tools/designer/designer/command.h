...
{
public:
    AddSlotCommand( const QString &name, FormWindow *fw, const QCString &s, const QString &a, const QString &l );
...
{
public:
    RemoveSlotCommand( const QString &name, FormWindow *fw, const QCString &s, const QString &a, const QString &l );
