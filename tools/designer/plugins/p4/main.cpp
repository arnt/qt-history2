...
QAction* P4Interface::create( const QString& actionname, QObject* parent )
{
	...
	actionSync = new QAction( "P4 Sync", QPixmap(sync_xpm), "&Sync", 0, p4Actions, "P4 Sync" );
	...
	actionEdit = new QAction( "P4 Edit", QPixmap(edit_xpm), "&Edit", 0, p4Actions, "P4 Edit" );
	...
	actionSubmit = new QAction( "P4 Submit", QPixmap(submit_xpm), "&Submit", 0, p4Actions, "P4 Submit" );
	...
	actionRevert = new QAction( "P4 Revert", QPixmap(revert_xpm), "&Revert", 0, p4Actions, "P4 Revert" );
	...
	actionAdd = new QAction( "P4 Add", QPixmap(add_xpm), "&Add", 0, p4Actions, "P4 Add" );
	...
	actionDelete = new QAction( "P4 Delete", QPixmap(delete_xpm), "&Delete", 0, p4Actions, "P4 Delete" );
	...
	actionDiff = new QAction( "P4 Diff", QPixmap(diff_xpm), "Di&ff", 0, p4Actions, "P4 Diff" );
	...
	a = new QAction( "P4 Refresh", QPixmap(refresh_xpm), "Refres&h", 0, p4Actions, "P4 Refresh" );
