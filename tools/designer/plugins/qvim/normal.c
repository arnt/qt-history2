 ...
 */
	...
	printf("inside giant if statement\n");
...
normal_end:
	...
	ui_cursor_shape();		/* may show different cursor shape */
    printf("after ui_cursor_shape()\n");
#endif

#ifdef CMDLINE_INFO
    if (oap->op_type == OP_NOP && oap->regname == 0) {
	printf("clearing cmd line\n");
	clear_showcmd();
    }
#endif
	...
	printf("before checkscrollbind\n");
	do_check_scrollbind(TRUE);
    }
#endif

    printf("before another big if statement\n");
    /*
