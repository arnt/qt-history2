...
**
** Created: Thu Apr 19 15:05:42 2001
    ...
    : QMainWindow( parent, name, fl )
{
    ...
    textEdit->setSizePolicy( QSizePolicy( (QSizePolicy::SizeType)7, (QSizePolicy::SizeType)7, textEdit->sizePolicy().hasHeightForWidth() ) );
    ...
    centerAlignAction->setIconSet( QIconSet( uic_load_pixmap_EditorForm( "textright" ) ) );
