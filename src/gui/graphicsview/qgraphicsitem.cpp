...
/*!
    ...
    Explicitly deleting an item before removing it from its scene is a
    significantly slower operation than removing the item first, and because
    of this, you should always remove the item explicitly before it is
    deleted.
*/
...
void QGraphicsItem::setAcceptsHoverEvents(bool enabled)
{
    ...
    // ### Notify the scene that this item now accepts hover events?
}
