...
/*!
    ...
    \brief The QGenericHeader class provides a header row or header column for item views.
...
/*!
    \enum QGenericHeader::ResizeMode
...
/*!
  \reimp
*/
void QGenericHeader::setModel(QAbstractItemModel *model)
{
