...
"false GPS dup 0 get SD S}if grestore}if}D/sl D0/QCIgray D0/QCIcolor D0\n"
"/QCIindex D0/QCI{/colorimage where{pop false 3 colorimage}{exec/QCIcolor ED\n"
"/QCIgray QCIcolor length 3 idiv string d 0 1 QCIcolor length 3 idiv 1 sub{\n"
"/QCIindex ED/x QCIindex 3 mul d QCIgray QCIindex QCIcolor x get 0.30 mul\n"
"QCIcolor x 1 add get 0.59 mul QCIcolor x 2 add get 0.11 mul add add cvi put}\n"
"for QCIgray image}ie}D/di{gsave TR 1 i 1 eq{false eq{pop true 3 1 roll 4 i 4\n"
"i false 4 i 4 i imagemask BkCol SC imagemask}{pop false 3 1 roll imagemask}\n"
"ie}{dup false ne{level3}{false}ie{/ma ED 8 eq{/dc[0 1]d/DeviceGray}{/dc[0 1\n"
"0 1 0 1]d/DeviceRGB}ie scs/im ED/mt ED/h ED/w ED/id <</ImageType 1/Width w\n"
"/Height h/ImageMatrix mt/DataSource im/BitsPerComponent 8/Decode dc >> d/md\n"
"<</ImageType 1/Width w/Height h/ImageMatrix mt/DataSource ma\n"
"/BitsPerComponent 1/Decode[0 1]>> d <</ImageType 3/DataDict id/MaskDict md\n"
"/InterleaveType 3 >> image}{pop 8 4 1 roll 8 eq{image}{QCI}ie}ie}ie grestore\n"
"}d/SetLinGrad{level3{/c2 ED/c1 ED/y2 ED/x2 ED/y1 ED/x1 ED/LinGrad <<\n"
"/PatternType 2 d/Shading <</ShadingType 2 d/ColorSpace[/DeviceRGB]d/Coords\n"
"[x1 y1 x2 y2]d/Extend[true true]d/Function <</FunctionType 2 d/Domain[0 1]d\n"
"/C0 c1 d/C1 c2 d/N 1 d >> d >> d >> matrix makepattern d}{pop}ie/BSt 15 d}D\n"
"/BF{gsave BSt 1 eq{BCol SC WFi{fill}{eofill}ie}if BSt 2 ge BSt 8 le and{\n"
"BDArr BSt 2 sub get/sc ED BCol{1. exch sub sc mul 1. exch sub}forall 3 array\n"
"astore SC WFi{fill}{eofill}ie}if BSt 9 ge BSt 14 le and{WFi{clip}{eoclip}ie\n"
"defM SM pathbbox 3 i 3 i TR 4 2 roll 3 2 roll exch sub/h ED sub/w ED OMo{NP\n"
"0 0 MT 0 h RL w 0 RL 0 h neg RL CP BkCol SC fill}if BCol SC 0.3 SW NP BSt 9\n"
"eq BSt 11 eq or{0 4 h{dup 0 exch MT w exch LT}for}if BSt 10 eq BSt 11 eq or{\n"
"0 4 w{dup 0 MT h LT}for}if BSt 12 eq BSt 14 eq or{w h gt{0 6 w h add{dup 0\n"
"MT h sub h LT}for}{0 6 w h add{dup 0 exch MT w sub w exch LT}for}ie}if BSt\n"
"13 eq BSt 14 eq or{w h gt{0 6 w h add{dup h MT h sub 0 LT}for}{0 6 w h add{\n"
"dup w exch MT w sub 0 exch LT}for}ie}if S}if BSt 15 eq{level3{LinGrad\n"
"setpattern WFi{fill}{eofill}ie}if}if BSt 24 eq{}if grestore}D/mat matrix d\n"
"/ang1 D0/ang2 D0/w D0/h D0/x D0/y D0/ARC{/ang2 ED/ang1 ED/h ED/w ED/y ED/x\n"
"ED mat CM pop x w 2 div add y h 2 div add TR 1 h w div neg scale ang2 0 ge{0\n"
"0 w 2 div ang1 ang1 ang2 add arc}{0 0 w 2 div ang1 ang1 ang2 add arcn}ie mat\n"
"SM}D/C D0/P{NP MT 0.5 0.5 rmoveto 0 -1 RL -1 0 RL 0 1 RL CP fill}D/M{/Cy ED\n"
"/Cx ED}D/L{NP Cx Cy MT/Cy ED/Cx ED Cx Cy LT QS}D/DL{NP MT LT QS}D/R{/h ED/w\n"
"ED/y ED/x ED NP x y MT 0 h RL w 0 RL 0 h neg RL CP BF QS}D/xr D0/yr D0/rx D0\n"
"/ry D0/rx2 D0/ry2 D0/E{/h ED/w ED/y ED/x ED mat CM pop x w 2 div add y h 2\n"
"div add TR 1 h w div scale NP 0 0 w 2 div 0 360 arc mat SM BF QS}D/BC{/BkCol\n"
"ED}D/BR{/BCol ED/BSt ED}D/NB{0[0 0 0]BR}D/PE{setlinejoin setlinecap/PCol ED\n"
"/LWi ED/PSt ED LWi 0 eq{0.25/LWi ED}if PCol SC}D/P1{1 0 3 2 roll 0 0 PE}D/ST\n"
"{defM SM concat}D/MF{true exch true exch{exch pop exch pop dup 0 get dup\n"
...
"}forall/Encoding fencoding d currentdict end}ie definefont pop}D/MFEmb{\n"
"findfont dup length dict begin{1 i/FID ne{d}{pop pop}ifelse}forall/Encoding\n"
"ED currentdict end definefont pop}D/DF{findfont/fs 3 -1 roll d[fs 0 0 fs -1\n"
"mul 0 0]makefont d}D/ty 0 d/Y{/ty ED}D/Tl{gsave SW NP 1 i exch MT 1 i 0 RL S\n"
"grestore}D/XYT{ty MT/xyshow where{pop pop xyshow}{exch pop 1 i dup length 2\n"
"div exch stringwidth pop 3 -1 roll exch sub exch div exch 0 exch ashow}ie}D\n"
"/AT{ty MT 1 i dup length 2 div exch stringwidth pop 3 -1 roll exch sub exch\n"
"div exch 0 exch ashow}D/QI{/C save d pageinit/Cx 0 d/Cy 0 d/OMo false d}D/QP\n"
"{C restore showpage}D/SPD{/setpagedevice where{<< 3 1 roll d >>\n"
"setpagedevice}{pop pop}ie}D/CLS{gsave NP}D/ACR{/h ED/w ED/y ED/x ED x y MT 0\n"
"h RL w 0 RL 0 h neg RL CP}D/CLO{grestore}D\n";
      ...
      printerState(QPrinter::Idle)
{
    ...
    if (embedFonts) {
        ...
        // append qsettings fontpath
        QStringList fp = settings.value(QLatin1String("fontPath")).toString().split(':');
        if (!fp.isEmpty())
            fontpath += fp;
    }
#else
