...
#endif
int qInitialLobSize(const QOCIPrivate *d, OCILobLocator *lob)
{
    ub4 i;
...
int qReadLob(T &buf, const QOCIPrivate *d, OCILobLocator *lob)
{
    ub4 read = 0;
    int r;
