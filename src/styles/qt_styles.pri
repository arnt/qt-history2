...
styles {
	...
	contains( styles, mac ) {
		HEADERS += $$STYLES_H/qmacstyle_mac.h $$STYLES_H/qmacstyleqd_mac.h #$$STYLES_H/qmacstylecg_mac.h
		SOURCES += $$STYLES_CPP/qmacstyle_mac.cpp $$STYLES_CPP/qmacstyleqd_mac.cpp $$STYLES_CPP/qmacstylecg_mac.cpp
