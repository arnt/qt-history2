...
{
    vec4 result;
    result.rgb = mix(dst.rgb * (src.a - (1 - dst.rgb / dst.a) * (2 * src.rgb - src.a)),
                     mix(dst.rgb * (src.a - (1 - dst.rgb / dst.a) * (2 * src.rgb - src.a) * (3 - 8 * dst.rgb / dst.a)),
                         (dst.rgb * src.a + (sqrt(dst.rgb / dst.a) * dst.a - dst.rgb) * (2 * src.rgb - src.a)),
