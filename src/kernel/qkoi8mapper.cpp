...
for $u (0x2500..(0x2500+$max-1)) {
    $uni = sprintf("%04x",$u);
    $koi8 = $unicode_to_koi8{$uni} || "a4"; # Black square
    print "0x$koi8,";
    print "\n\t" if $u % 8 == 7;
}
print "};\n\n";
...
static const char unicode_to_koi8_25[161] = {
	...
	,};
...
char* QKOI8Mapper::fromUnicode(const QString& uc, int& len_in_out) const
{
...
QString QKOI8Mapper::toUnicode(const char* chars, int len) const
{
    QString result;
    for (int i=0; i<len; i++) {
	uchar ch = chars[i];
...
const char* QKOI8Mapper::name() const
{
    return "KOI8-R";
}
...
int QKOI8Mapper::heuristicContentMatch(const char* chars, int len) const
{
    int score = 0;
    for (int i=0; i<len; i++) {
	uchar ch = chars[i];
