...
Qt::HANDLE QCursor::handle() const
{
    ...
    if ( !data->hcurs )
	update();
    return data->hcurs ? *data->hcurs : NULL;
}
...
void QCursor::update() const
{
    ...
    static const uchar *cursor_bits20[] = {   forbidden_bits, forbiddenm_bits  };
	...
	case CrossCursor:
	    d->hcurs = GetCursor(::crossCursor);
	    break;
	case WaitCursor:
	    d->hcurs = GetCursor(::watchCursor);
	    break;
	case IbeamCursor:
	    d->hcurs = GetCursor(::iBeamCursor);
	    break;
	case SizeAllCursor:
	    d->hcurs = GetCursor(::plusCursor);
	    break;
