...
"{false}ie{/ma ED dup 1 eq{pop/dc[0 1]d/DeviceGray/bpp 1 d}{8 eq{/dc[0 1]d\n"
"/DeviceGray}{/dc[0 1 0 1 0 1]d/DeviceRGB}ie/bpp 8 d}scs/im ED/mt ED/h ED/w\n"
"ED/id 7 DB/ImageType 1 d/Width w d/Height h d/ImageMatrix mt d/DataSource im\n"
"d/BitsPerComponent bpp d/Decode dc d DE/md 7 DB/ImageType 1 d/Width w d\n"
"/Height h d/ImageMatrix mt d/DataSource ma d/BitsPerComponent 1 d/Decode[0\n"
"1]d DE 4 DB/ImageType 3 d/DataDict id d/MaskDict md d/InterleaveType 3 d end\n"
"image}{pop dup 1 eq{pop false 3 1 roll imagemask}{8 4 1 roll 8 eq{image}{QCI\n"
"}ie}ie}ie grestore}d/BF{gsave BSt 1 eq{BCol SC WFi{fill}{eofill}ie}if BSt 2\n"
...
"for}{0 6 w h add{dup w exch MT w sub 0 exch LT}for}ie}if S}if BSt 24 eq{}if\n"
...
"0 1 RL CP PCol SC fill}D/M{/Cy ED/Cx ED}D/L{NP Cx Cy MT/Cy ED/Cx ED Cx Cy LT\n"
"QS}D/DL{NP MT LT QS}D/HL{1 i DL}D/VL{2 i exch DL}D/R{/h ED/w ED/y ED/x ED NP\n"
"x y MT 0 h RL w 0 RL 0 h neg RL CP BF QS}D/ACR{/h ED/w ED/y ED/x ED x y MT 0\n"
"h RL w 0 RL 0 h neg RL CP}D/xr D0/yr D0/rx D0/ry D0/rx2 D0/ry2 D0/RR{/yr ED\n"
"/xr ED/h ED/w ED/y ED/x ED xr 0 le yr 0 le or{x y w h R}{xr 100 ge yr 100 ge\n"
"or{x y w h E}{/rx xr w mul 200 div d/ry yr h mul 200 div d/rx2 rx 2 mul d\n"
"/ry2 ry 2 mul d NP x rx add y MT x y rx2 ry2 180 -90 x y h add ry2 sub rx2\n"
"ry2 270 -90 x w add rx2 sub y h add ry2 sub rx2 ry2 0 -90 x w add rx2 sub y\n"
"rx2 ry2 90 -90 ARC ARC ARC ARC CP BF QS}ie}ie}D/E{/h ED/w ED/y ED/x ED mat\n"
"CM pop x w 2 div add y h 2 div add TR 1 h w div scale NP 0 0 w 2 div 0 360\n"
"arc mat SM BF QS}D/A{16 div exch 16 div exch NP ARC QS}D/PIE{/ang2 ED/ang1\n"
"ED/h ED/w ED/y ED/x ED NP x w 2 div add y h 2 div add MT x y w h ang1 16 div\n"
"ang2 16 div ARC CP BF QS}D/CH{16 div exch 16 div exch NP ARC CP BF QS}D/BZ{\n"
"curveto QS}D/CRGB{255 div 3 1 roll 255 div 3 1 roll 255 div 3 1 roll}D/BC{\n"
"CRGB BkCol sp}D/BR{CRGB BCol sp/BSt ED}D/WB{1 W BR}D/NB{0 B BR}D/PE{\n"
"setlinejoin setlinecap CRGB PCol sp/LWi ED/PSt ED LWi 0 eq{0.25/LWi ED}if}D\n"
"/P1{1 0 5 2 roll 0 0 PE}D/ST{defM SM concat}D/MF{true exch true exch{exch\n"
...
"SW PCol SC NP 1 i exch MT 1 i 0 RL S grestore}D/XYT{PCol SC ty MT/xyshow\n"
"where{pop pop xyshow}{exch pop 1 i dup length 2 div exch stringwidth pop 3\n"
"-1 roll exch sub exch div exch 0 exch ashow}ie}D/AT{PCol SC ty MT 1 i dup\n"
"length 2 div exch stringwidth pop 3 -1 roll exch sub exch div exch 0 exch\n"
"ashow}D/QI{/C save d pageinit/Cx 0 d/Cy 0 d/OMo false d}D/QP{C restore\n"
