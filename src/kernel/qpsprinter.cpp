...
"decode d end d/Mask 7 dict dup begin/ImageType 1 d/Width width d/Height\n"
"height d/ImageMatrix matrix d/DataSource ma d/BitsPerComponent 1 d/Decode[0\n"
"1]d end d 4 dict dup begin/ImageType 3 d/DataDict Image d/MaskDict Mask d\n"
"/InterleaveType 3 d end image}{pop dup 1 eq{pop false 3 1 roll imagemask}{8\n"
"4 1 roll 8 eq{image}{QCI}ifelse}ifelse}ifelse grestore}d/defM matrix d/BF{\n"
...
"ifelse defM SM pathbbox 3 index 3 index translate 4 2 roll 3 2 roll exch sub\n"
"/h ED sub/w ED OMo{NP 0 0 MT 0 h RL w 0 RL 0 h neg RL CP BkCol SC fill}if\n"
"BCol SC 0.3 SW NP BSt 9 eq BSt 11 eq or{0 4 h{dup 0 exch MT w exch LT}for}if\n"
"BSt 10 eq BSt 11 eq or{0 4 w{dup 0 MT h LT}for}if BSt 12 eq BSt 14 eq or{w h\n"
"gt{0 6 w h add{dup 0 MT h sub h LT}for}{0 6 w h add{dup 0 exch MT w sub w\n"
"exch LT}for}ifelse}if BSt 13 eq BSt 14 eq or{w h gt{0 6 w h add{dup h MT h\n"
"sub 0 LT}for}{0 6 w h add{dup w exch MT w sub 0 exch LT}for}ifelse}if S}if\n"
"BSt 24 eq{}if grestore}D/mat matrix d/ang1 D0/ang2 D0/w D0/h D0/x D0/y D0\n"
...
"w 2 div ang1 ang1 ang2 add arcn}ifelse mat SM}D/C D0/P{NP MT 0.5 0.5 rmoveto\n"
"0 -1 RL -1 0 RL 0 1 RL CP PCol SC fill}D/M{/Cy ED/Cx ED}D/L{NP Cx Cy MT/Cy\n"
"ED/Cx ED Cx Cy LT QS}D/DL{NP MT LT QS}D/HL{1 index DL}D/VL{2 index exch DL}D\n"
"/R{/h ED/w ED/y ED/x ED NP x y MT 0 h RL w 0 RL 0 h neg RL CP BF QS}D/ACR{/h\n"
...
"-90 x w add rx2 sub y rx2 ry2 90 -90 ARC ARC ARC ARC CP BF QS}ifelse}ifelse}\n"
"D/E{/h ED/w ED/y ED/x ED mat CM pop x w 2 div add y h 2 div add translate 1\n"
"h w div scale NP 0 0 w 2 div 0 360 arc mat SM BF QS}D/A{16 div exch 16 div\n"
...
"3 1 roll 255 div 3 1 roll}D/BC{CRGB BkCol astore pop}D/BR{CRGB BCol astore\n"
"pop/BSt ED}D/WB{1 W BR}D/NB{0 B BR}D/PE{setlinejoin setlinecap CRGB PCol\n"
"astore pop/LWi ED/PSt ED LWi 0 eq{0.25/LWi ED}if}D/P1{1 0 5 2 roll 0 0 PE}D\n"
"/ST{defM setmatrix concat}D/qtfindfont{true exch true exch{exch pop exch pop\n"
"dup 0 get dup findfont dup/FontName get 3 -1 roll eq{exit}if}forall exch}D\n"
"/qtdefinefont{dup 1 get/fxscale exch def 2 get/fslant exch def exch\n"
"/fencoding exch def[fxscale 0 fslant 1 0 0]makefont fencoding false eq{}{dup\n"
"maxlength dict begin{1 index/FID ne{def}{pop pop}ifelse}forall/Encoding\n"
"fencoding def currentdict end}ifelse definefont pop}D/MF{qtfindfont\n"
"qtdefinefont}D/MFEmb{findfont dup length dict begin{1 index/FID ne{d}{pop\n"
"pop}ifelse}forall/Encoding ED currentdict end definefont pop}D/DF{findfont\n"
"/FONTSIZE 3 -1 roll d[FONTSIZE 0 0 FONTSIZE -1 mul 0 0]makefont d}D/ty 0 d/Y\n"
"{/ty ED}D/Tl{gsave setlinewidth PCol SC NP 1 index exch MT 1 index 0 rlineto\n"
"stroke grestore}D/T{PCol SC ty MT 1 index dup length 2 div exch stringwidth\n"
"pop 3 -1 roll exch sub exch div exch 0 exch ashow}D/QI{/C save d pageinit/Cx\n"
"0 d/Cy 0 d/OMo false d}D/QP{C restore showpage}D/SPD{/setpagedevice where{1\n"
"dict dup begin 3 1 roll def end setpagedevice}{pop pop}ifelse}D/SV{BSt LWi\n"
"PSt Cx Cy WFi OMo BCol PCol BkCol/nS nS 1 add d gsave}D/RS{nS 0 gt{grestore\n"
"/BkCol ED/PCol ED/BCol ED/OMo ED/WFi ED/Cy ED/Cx ED/PSt ED/LWi ED/BSt ED/nS\n"
"nS 1 sub d}if}D/CLSTART{/clipTmp matrix CM d defM SM NP}D/CLEND{clip NP\n"
"clipTmp SM}D/CLO{grestore gsave defM SM}D\n";
