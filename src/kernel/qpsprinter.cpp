...
"d}D/BSt 0 d/LWi 1 d/PSt 1 d/Cx 0 d/Cy 0 d/WFi false d/OMo false d/BCol[1 1 1\n"
"]d/PCol[0 0 0]d/BkCol[1 1 1]d/BDArr[0.06 0.12 0.37 0.50 0.63 0.88 0.94]d\n"
"/defM matrix d/nS 0 d/GPS{PSt 1 ge PSt 5 le and{{LArr PSt 1 sub 2 mul get}{\n"
"LArr PSt 2 mul 1 sub get}ifelse}{[]}ifelse}D/QS{PSt 0 ne{LWi SW gsave PCol\n"
"SC true GPS 0 SD S OMo PSt 1 ne and grestore{BkCol SC false GPS dup 0 get SD\n"
"S}if}if}D/r28{{CR dup 32 gt{exit}if pop}loop 3{CR}repeat 0 4{7 bs exch dup\n"
"128 gt{84 sub}if 42 sub 127 and add}repeat}D/rA 0 d/rL 0 d/rB{rL 0 eq{/rA\n"
"r28 d/rL 28 d}if dup rL gt{rA exch rL sub rL exch/rA 0 d/rL 0 d rB exch bs\n"
"add}{dup rA 16#fffffff 3 -1 roll bs not and exch dup rL exch sub/rL ED neg\n"
"rA exch bs/rA ED}ifelse}D/uc{/rL 0 d 0{dup 2 i length ge{exit}if 1 rB 1 eq{3\n"
"rB dup 3 ge{1 add dup rB 1 i 5 ge{1 i 6 ge{1 i 7 ge{1 i 8 ge{128 add}if 64\n"
"add}if 32 add}if 16 add}if 3 add exch pop}if 3 add exch 10 rB 1 add{dup 3 i\n"
"lt{dup}{2 i}ifelse 4 i 3 i 3 i sub 2 i getinterval 5 i 4 i 3 -1 roll\n"
...
"add get 0.11 mul add add cvi put}for QCIgray image}ifelse}D/di{gsave TR dup\n"
"false ne{/languagelevel where{pop languagelevel 2 ge}{false}ifelse}{false}\n"
"ifelse{/ma ED 8 eq{/dc[0 1]d/DeviceGray}{/dc[0 1 0 1 0 1]d/DeviceRGB}ifelse\n"
...
"imagemask}{8 4 1 roll 8 eq{image}{QCI}ifelse}ifelse}ifelse grestore}d/BF{\n"
"gsave BSt 1 eq{BCol SC WFi{fill}{eofill}ifelse}if BSt 2 ge BSt 8 le and{\n"
"BDArr BSt 2 sub get setgray fill}if BSt 9 ge BSt 14 le and{WFi{clip}{eoclip}\n"
"ifelse defM SM pathbbox 3 i 3 i TR 4 2 roll 3 2 roll exch sub/h ED sub/w ED\n"
"OMo{NP 0 0 MT 0 h RL w 0 RL 0 h neg RL CP BkCol SC fill}if BCol SC 0.3 SW NP\n"
"BSt 9 eq BSt 11 eq or{0 4 h{dup 0 exch MT w exch LT}for}if BSt 10 eq BSt 11\n"
"eq or{0 4 w{dup 0 MT h LT}for}if BSt 12 eq BSt 14 eq or{w h gt{0 6 w h add{\n"
"dup 0 MT h sub h LT}for}{0 6 w h add{dup 0 exch MT w sub w exch LT}for}\n"
"ifelse}if BSt 13 eq BSt 14 eq or{w h gt{0 6 w h add{dup h MT h sub 0 LT}for}\n"
"{0 6 w h add{dup w exch MT w sub 0 exch LT}for}ifelse}if S}if BSt 24 eq{}if\n"
...
"ang1 ang2 add arcn}ifelse mat SM}D/C D0/P{NP MT 0.5 0.5 rmoveto 0 -1 RL -1 0\n"
"RL 0 1 RL CP PCol SC fill}D/M{/Cy ED/Cx ED}D/L{NP Cx Cy MT/Cy ED/Cx ED Cx Cy\n"
"LT QS}D/DL{NP MT LT QS}D/HL{1 i DL}D/VL{2 i exch DL}D/R{/h ED/w ED/y ED/x ED\n"
"NP x y MT 0 h RL w 0 RL 0 h neg RL CP BF QS}D/ACR{/h ED/w ED/y ED/x ED x y\n"
"MT 0 h RL w 0 RL 0 h neg RL CP}D/xr D0/yr D0/rx D0/ry D0/rx2 D0/ry2 D0/RR{\n"
...
"sub y rx2 ry2 90 -90 ARC ARC ARC ARC CP BF QS}ifelse}ifelse}D/E{/h ED/w ED/y\n"
"ED/x ED mat CM pop x w 2 div add y h 2 div add TR 1 h w div scale NP 0 0 w 2\n"
"div 0 360 arc mat SM BF QS}D/A{16 div exch 16 div exch NP ARC QS}D/PIE{/ang2\n"
"ED/ang1 ED/h ED/w ED/y ED/x ED NP x w 2 div add y h 2 div add MT x y w h\n"
"ang1 16 div ang2 16 div ARC CP BF QS}D/CH{16 div exch 16 div exch NP ARC CP\n"
"BF QS}D/BZ{curveto QS}D/CRGB{255 div 3 1 roll 255 div 3 1 roll 255 div 3 1\n"
"roll}D/BC{CRGB BkCol astore pop}D/BR{CRGB BCol astore pop/BSt ED}D/WB{1 W BR\n"
"}D/NB{0 B BR}D/PE{setlinejoin setlinecap CRGB PCol astore pop/LWi ED/PSt ED\n"
"LWi 0 eq{0.25/LWi ED}if}D/P1{1 0 5 2 roll 0 0 PE}D/ST{defM SM concat}D/MF{\n"
...
"fencoding d currentdict end}ifelse definefont pop}D/MFEmb{findfont dup\n"
"length dict begin{1 i/FID ne{d}{pop pop}ifelse}forall/Encoding ED\n"
"currentdict end definefont pop}D/DF{findfont/fs 3 -1 roll d[fs 0 0 fs -1 mul\n"
"0 0]makefont d}D/ty 0 d/Y{/ty ED}D/Tl{gsave SW PCol SC NP 1 i exch MT 1 i 0\n"
"RL S grestore}D/T{PCol SC ty MT 1 i dup length 2 div exch stringwidth pop 3\n"
"-1 roll exch sub exch div exch 0 exch ashow}D/QI{/C save d pageinit/Cx 0 d\n"
"/Cy 0 d/OMo false d}D/QP{C restore showpage}D/SPD{/setpagedevice where{1 DB\n"
"3 1 roll d end setpagedevice}{pop pop}ifelse}D/SV{BSt LWi PSt Cx Cy WFi OMo\n"
"BCol PCol BkCol/nS nS 1 add d gsave}D/RS{nS 0 gt{grestore/BkCol ED/PCol ED\n"
"/BCol ED/OMo ED/WFi ED/Cy ED/Cx ED/PSt ED/LWi ED/BSt ED/nS nS 1 sub d}if}D\n"
"/CLSTART{/clipTmp matrix CM d defM SM NP}D/CLEND{clip NP clipTmp SM}D/CLO{\n"
"grestore gsave defM SM}D\n";
