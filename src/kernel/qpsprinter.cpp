...
"false d/OMo false d/BCol[1 1 1]d/PCol[0 0 0]d/BkCol[1 1 1]d/BDArr[0.06 0.12\n"
"0.37 0.50 0.63 0.88 0.94]d/defM matrix d/nS 0 d/GPS{PSt 1 ge PSt 5 le and{{\n"
...
"BCol SC WFi{fill}{eofill}ie}if BSt 2 ge BSt 8 le and{BDArr BSt 2 sub get\n"
"setgray fill}if BSt 9 ge BSt 14 le and{WFi{clip}{eoclip}ie defM SM pathbbox\n"
"3 i 3 i TR 4 2 roll 3 2 roll exch sub/h ED sub/w ED OMo{NP 0 0 MT 0 h RL w 0\n"
...
"{0 6 w h add{dup 0 exch MT w sub w exch LT}for}ie}if BSt 13 eq BSt 14 eq or{\n"
"w h gt{0 6 w h add{dup h MT h sub 0 LT}for}{0 6 w h add{dup w exch MT w sub\n"
"0 exch LT}for}ie}if S}if BSt 24 eq{}if grestore}D/mat matrix d/ang1 D0/ang2\n"
"D0/w D0/h D0/x D0/y D0/ARC{/ang2 ED/ang1 ED/h ED/w ED/y ED/x ED mat CM pop x\n"
"w 2 div add y h 2 div add TR 1 h w div neg scale ang2 0 ge{0 0 w 2 div ang1\n"
