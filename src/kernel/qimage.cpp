...
#if defined(_WS_WIN_)
HDC QImage::handle() const { return data->pm ? data->pm->handle() : 0; }
#elif defined(_WS_PM_)
HPS QImage::handle() const { return data->pm ? data->pm->handle() : 0; }
...
// --------------------------------------------------------------------------
// QPixMap/QImage stream functions
//
