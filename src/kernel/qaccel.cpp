/****************************************************************************
** $Id: //depot/qt/main/src/kernel/qaccel.cpp#12 $
**
...
#if defined(DEBUG)
static char ident[] = "$Id: //depot/qt/main/src/kernel/qaccel.cpp#12 $";
#endif
...
More stricly, A QAccel is a number of accelerator items. An
accelerator item consists of a keyboard code combined with modifiers
(SHIFT, CTRL and ALT), for example <code>CTRL + Key_P</code> could be
a shortcut for printing a document.  The key codes are listed in
qkeycode.h.
