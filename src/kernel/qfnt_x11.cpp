/****************************************************************************
** $Id: //depot/qt/main/src/kernel/qfnt_x11.cpp#11 $
**
...
#if defined(DEBUG)
static char ident[] = "$Id: //depot/qt/main/src/kernel/qfnt_x11.cpp#11 $";
#endif
...
enum qXFontFieldNames {	Foundry,		// !!!hanord: Enum har stor forbokstav, f.eks. FontFieldNames (qX.. er for globale funksjoner)
			Family,
			Weight_,
			Slant,
			Width,
