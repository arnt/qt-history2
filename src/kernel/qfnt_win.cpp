/****************************************************************************
** $Id: //depot/qt/main/src/kernel/qfnt_win.cpp#27 $
**
...
RCSTAG("$Id: //depot/qt/main/src/kernel/qfnt_win.cpp#27 $");
...
#undef  TM
#define TM (t == FontInternal ? u.f->textMetric() : (TEXTMETRIC*)textMetric())
