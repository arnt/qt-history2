...
public:
    QUriDrag( QPtrStrList uris, QWidget * dragSource = 0, const char * name = 0 );
    ...
    virtual void setUris( QPtrStrList uris );
    ...
    static bool canDecode( const QMimeSource* e );
    static bool decode( const QMimeSource* e, QPtrStrList& i );
