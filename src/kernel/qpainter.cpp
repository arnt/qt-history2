/****************************************************************************
** $Id: //depot/qt/main/src/kernel/qpainter.cpp#71 $
**
...
RCSTAG("$Id: //depot/qt/main/src/kernel/qpainter.cpp#71 $")
...
/*****************************************************************************
  QPainter member functions for drawing shadow effects.
 *****************************************************************************/
...
/*!
  \fn void QPainter::drawShadeRect( const QRect &r, const QColor &tc, const QColor &bc, int lw, const QColor &mc, int mlw )
*/
...
/*!
  \overload void QPainter::drawShadePanel( const QRect &r, const QColor &tc, const QColor &bc, int lw, const QColor &fc, bool fill )
*/
...
/*----------------------------------------------------------------------------
  ...
  \warning This function will go away in Qt 0.94. Use qDrawShadeLine()
  instead.
...
{
    debug( "QPainter::drawShadeLine: This function is obsolete\n\t"
	   "use qDrawShadeLine instead" );
...
/*----------------------------------------------------------------------------
  ...
  \warning This function will go away in Qt 0.94. Use qDrawShadeRect()
  instead.
...
void QPainter::drawShadeRect( int x, int y, int w, int h,
			      ...
			      int lw, const QColor &mColor, int mlw )
{
    debug( "QPainter::drawShadeRect: This function is obsolete\n\t"
	   "use qDrawShadeRect instead" );
...
{
    debug( "QPainter::drawShadePanel: This function is obsolete\n\t"
	   "use qDrawShadePanel instead" );
