...
QString QUuid::toString() const
{
    ...
    result += QString::number( data2, 16 ).rightJustify( 2, '0' ) + "-";
    result += QString::number( data3, 16 ).rightJustify( 2, '0' ) + "-";
    result += QString::number( data4[0], 16 ).rightJustify( 2, '0' );
    result += QString::number( data4[1], 16 ).rightJustify( 2, '0' ) + "-";
    for ( int i = 2; i < 8; i++ )
	result += QString::number( data4[i], 16 ).rightJustify( 2, '0' );
