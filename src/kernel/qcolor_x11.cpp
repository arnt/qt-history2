/****************************************************************************
** $Id: //depot/qt/main/src/kernel/qcolor_x11.cpp#12 $
**
...
#if defined(DEBUG)
static char ident[] = "$Id: //depot/qt/main/src/kernel/qcolor_x11.cpp#12 $";
#endif
...
void QColor::initialize()			// called from startup routines
{
  ...
  // Initialize global color objects
    ...
    if ( white.pixel() == 0 ) {
	((QColor*)(&color0))->pix = white.pixel();
	((QColor*)(&color1))->pix = black.pixel();
    }
    else {
	((QColor*)(&color0))->pix = black.pixel();
	((QColor*)(&color1))->pix = white.pixel();
    }
