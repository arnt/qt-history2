/****************************************************************************
** $Id: //depot/qt/main/src/kernel/qrgn_win.cpp#1 $
**
...
#if defined(DEBUG)
static char ident[] = "$Id: //depot/qt/main/src/kernel/qrgn_win.cpp#1 $";
#endif
...
{
    return data->rgn ? PtInRegion( data->rgn, p.getX(), p.getY() ) : FALSE;
}
