/****************************************************************************
** $Id: //depot/qt/main/src/kernel/qapp.cpp#103 $
**
...
RCSTAG("$Id: //depot/qt/main/src/kernel/qapp.cpp#103 $");
...
{
    QColor standardLightGray( 204, 204, 204 );
    QColor light( standardLightGray.light( 121 ) );
