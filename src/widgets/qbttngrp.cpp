/****************************************************************************
** $Id: //depot/qt/main/src/widgets/qbttngrp.cpp#14 $
**
...
#if defined(DEBUG)
static char ident[] = "$Id: //depot/qt/main/src/widgets/qbttngrp.cpp#14 $";
#endif
...
void QButtonGroup::buttonClicked()
{
	...
	if ( sobj == i->button )		// button was clicked
	    ...
	    i->button->switchOff();		// switch other radio buttons off
    }
    if ( id != -1 )
	emit clicked( id );
}
