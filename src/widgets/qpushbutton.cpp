/****************************************************************************
** $Id: //depot/qt/main/src/widgets/qpushbutton.cpp#6 $
**
...
#if defined(DEBUG)
static char ident[] = "$Id: //depot/qt/main/src/widgets/qpushbutton.cpp#6 $";
#endif
...
static void resizeDefButton( QPushButton *b )
{
    ...
    QRect r = b->geometry();
    b->QWidget::changeGeometry( r.x()-wx/2, r.y()-hx/2,
