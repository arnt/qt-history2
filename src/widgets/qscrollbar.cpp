...
/*!
  ...
  new scroll bar \a value as an argument.
*/
...
/*!
  ...
  Sets the background color to the mid color for Motif style scroll bars using palette \a p.
*/
...
void QScrollBar::action( QStyle::SubControl control )
{
    switch( control ) {
			       ...
			       QPainter *p ) const
{
    ...
    style().drawComplexControl(QStyle::CC_ScrollBar, p, this, rect(), colorGroup(),
			       ...
			       (QStyle::SubControl) activeControl, data);
}
...
/*!
  ...
  When setting this property, the \l QScrollBar::maxValue is adjusted
...
/*!
  ...
  When setting this property, the \l QScrollBar::minValue is adjusted
  so that the range remains valid if necessary.
