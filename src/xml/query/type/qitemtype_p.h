...
namespace Patternist
{
     ...
     * Nodes, represented by Node, and atom types, represented by AtomicType.
     *
    ...
    public:
         ...
         */
        typedef PlainSharedPtr<ItemType> Ptr;
        /**
...
Q_DECLARE_TYPEINFO(Patternist::ItemType::Ptr, Q_MOVABLE_TYPE);
