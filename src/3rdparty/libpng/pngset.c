             ...
             png_charp profile, png_uint_32 proflen)
{
   ...
   new_iccp_name = (char *)png_malloc(png_ptr, png_strlen(name)+1);
   strcpy(new_iccp_name, name);
   new_iccp_profile = (char *)png_malloc(png_ptr, proflen);
...
#endif
       png_ptr->trans = info_ptr->trans = (unsigned char *)png_malloc(png_ptr, num_trans);
   ...
   chunk_list, int num_chunks)
{
    ...
    new_list=(unsigned char *)png_malloc(png_ptr,5*(num_chunks+old_num_chunks));
