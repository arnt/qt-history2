...
/*
   Trolltech note: this xlc preprocessor bug seems connected to the use of
   the -qlanglvl=classic option which is broken. We don't use this option
   anymore so let's get rid of the workaround.
*/
#if 0 && defined(_AIX) && defined(__xlC__)
