/****************************************************************************
** $Id: //depot/qt/main/src/dialogs/qfiledialog.cpp#57 $
**
...
RCSTAG("$Id: //depot/qt/main/src/dialogs/qfiledialog.cpp#57 $");
...
void QFileDialogPrivate::MCList::setFocusToPoint( const QPoint & p )
{
    ...
    ((QListViewItem *)file)->setSelected( TRUE );
    int x = focusCol, y = focusRow;
    focusRow = row;
    focusCol = col;
    updateCell( row, col );
    updateCell( x, y );
