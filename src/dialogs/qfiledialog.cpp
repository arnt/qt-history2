/****************************************************************************
** $Id: //depot/qt/main/src/dialogs/qfiledialog.cpp#46 $
**
...
RCSTAG("$Id: //depot/qt/main/src/dialogs/qfiledialog.cpp#46 $");
					  ...
					  int c, int w ) const
{
	...
	if ( info.isDir() ) {
	    if ( !openFolderIcon )
		makeIcons();
	    QPixmap * pm = isOpen() ? openFolderIcon : closedFolderIcon;
	    p->drawPixmap( 16 - pm->width(), (height()-pm->height())/2, *pm );
	    r.setLeft( 18 );
	}
