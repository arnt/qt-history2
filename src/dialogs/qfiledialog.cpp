/****************************************************************************
** $Id: //depot/qt/main/src/dialogs/qfiledialog.cpp#72 $
**
...
RCSTAG("$Id: //depot/qt/main/src/dialogs/qfiledialog.cpp#72 $");
...
void QFileDialog::updateFileNameEdit( QListViewItem * newItem )
{
	...
	// Nothing selected - user considers nameEdit to be selection
	fileNameEditDone();
    }
}
