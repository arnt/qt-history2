/****************************************************************************
** $Id: //depot/qt/main/src/dialogs/qfiledialog.cpp#80 $
**
...
RCSTAG("$Id: //depot/qt/main/src/dialogs/qfiledialog.cpp#80 $");
...
class QNoisyLineEdit : public QLineEdit {
    QFileDialog* fd;
public:
    QNoisyLineEdit(QFileDialog* parent, const char* name) :
...
void QFileDialog::init()
{
    ...
    nameEdit = new QNoisyLineEdit( this, "name/filter editor" );
...
#error "Use initialSelection to set the initial file if it !isEmpty()"
    QString result;
...
bool QFileDialog::trySetSelection( const QFileInfo& info, bool updatelined )
{
    ...
    okB->setEnabled( !d->currentFileName.isNull() || info.isDir() );
