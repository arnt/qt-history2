/****************************************************************************
** $Id: //depot/qt/main/src/dialogs/qfiledialog.cpp#53 $
**
...
RCSTAG("$Id: //depot/qt/main/src/dialogs/qfiledialog.cpp#53 $");
...
debug("fl=%d all_len=%d total_len=%d alloc=%d",
fl,all_len,total_len,2*fl+all_len);
    } else {
	win_filter = new char[all_len];
    }
    memcpy(win_filter+total_len, all_filter, all_len);
debug("total used = %d",total_len+all_len);
