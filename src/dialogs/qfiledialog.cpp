/****************************************************************************
** $Id: //depot/qt/main/src/dialogs/qfiledialog.cpp#58 $
**
...
RCSTAG("$Id: //depot/qt/main/src/dialogs/qfiledialog.cpp#58 $");
...
void QFileDialog::init()
{
    ...
    d->detailView = new QPushButton( "x", this, "list view" ); // ## pm
    connect( d->detailView, SIGNAL(clicked()),
	     this, SLOT(detailViewClicked()) );
    d->mcView = new QPushButton( "y", this, "mclistbox view" ); // ## pm
    connect( d->mcView, SIGNAL(clicked()),
	     this, SLOT(mcViewClicked()) );
...
void QFileDialog::detailViewClicked()
{
    d->stack->raiseWidget( files );
}


void QFileDialog::mcViewClicked()
{
