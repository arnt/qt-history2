/****************************************************************************
** $Id: //depot/qt/main/src/tools/qptrcollection.cpp#5 $
**
...
/*!
  \fn QPtrCollection::~QPtrCollection()
  Destroys the collection. The destructor is protected because QPtrCollection
...
{
    if ( del_item )
	operator delete( d );			// default operation
}
