...
#define QT_FEATURE_IMAGEIO_XBM		0
#define QT_FEATURE_IMAGEIO_XPM		0
#define QT_FEATURE_IMAGEIO_PNG		0
...
// misc
#define QT_FEATURE_MIME			0
#define QT_FEATURE_RICHTEXT		0 && QT_FEATURE_MIME
...
#define QT_FEATURE_QWS_CURSOR		0 && defined(_WS_QWS_)
...
#define QT_FEATURE_QWS_DEPTH_16		0 && defined(_WS_QWS_)
#define QT_FEATURE_QWS_DEPTH_32		0 && defined(_WS_QWS_)

// network
#define QT_FEATURE_NETWORKPROTOCOL	0
...
// widgets
#define QT_FEATURE_WIDGETS		0   // 0 disables all except QWidget
