/****************************************************************************
** $Id: //depot/qt/main/src/tools/qdatastream.cpp#27 $
**
...
RCSTAG("$Id: //depot/qt/main/src/tools/qdatastream.cpp#27 $");
...
static INT32 read_int_ascii( QDataStream *s )
{
    register int n = 0;
    char buf[40];
    while ( TRUE ) {
...
QDataStream &QDataStream::operator>>( INT8 &i )
{
...
/*!
  ...
  The serialization format is an UINT32 length specifier first, then the
  data (\e length bytes).
