...
/*!
  ...
  \sa createObjectImpl()
 */
void Ui3Reader::createObjectDecl( const QDomElement& e )
{
    if ( e.tagName() == "vbox" ) {
...
QString Ui3Reader::createObjectImpl( const QDomElement &e, const QString& parentClass, const QString& par, const QString& layout )
{
    QString parent( par );
...
void Ui3Reader::createSpacerDecl( const QDomElement &e )
{
