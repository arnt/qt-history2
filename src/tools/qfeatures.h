...
// images
#define QT_FEATURE_IMAGEIO_BMP		1
#define QT_FEATURE_IMAGEIO_PPM		1
#define QT_FEATURE_IMAGEIO_XBM		1
#define QT_FEATURE_IMAGEIO_XPM		1
#define QT_FEATURE_IMAGEIO_PNG		1
#define QT_FEATURE_IMAGEIO_JPEG		1 // currently also requires QT_JPEG_SUPPORT
...
#define QT_FEATURE_QWS_VFB		1 && defined(_WS_QWS_)
