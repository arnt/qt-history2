...
QPoint.prototype.translate = function() {
    if (arguments.length == 2) {
        ...
        throw new Error("QPoint.prototype.translate: invalid number of arguments");
    }
    return this;
}
...
QSize.prototype.scale = function() {
    ...
    var mode;
    if (arguments.length < 2)
        throw new Error("QSize.prototype.scale: too few arguments");
    if (arguments.length == 2) {
...
QLine.prototype.translate = function() {
    if (arguments.length == 2) {
        ...
        throw new Error("QLine.prototype.translate: invalid number of arguments");
    }
    return this;
}
...
QLine.prototype.toString = function() {
    return "QLine(" + this.p1.x + ", " + this.p1.y + ", "
                    + this.p2.x + ", " + this.p2.y + ")";
}
...
QRect.prototype.translate = function() {
    ...
    if (arguments.length == 2) {
        ...
        throw new Error("QRect.prototype.translate: invalid number of arguments");
    }
    this.x += dx;
    this.y += dy;
    return this;
...
QRect.prototype.translated = function() {
    ...
    if (arguments.length == 2) {
        ...
        throw new Error("QRect.prototype.translated: invalid number of arguments");
    }
...
QRect.prototype.moveTo = function() {
    ...
    if (arguments.length == 2) {
        ...
        throw new Error("QRect.prototype.moveTo: invalid number of arguments");
    }
    this.x = x;
    this.y = y;
    return this;
