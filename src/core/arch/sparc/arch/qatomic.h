...
extern "C" {
    Q_CORE_EXPORT int q_atomic_test_and_test_int(volatile int *ptr, int expected, int newval);
    Q_CORE_EXPORT int q_atomic_test_and_test_ptr(volatile void *ptr, void *expected, void *newval);
