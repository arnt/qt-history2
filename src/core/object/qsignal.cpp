                 ...
                 QGenericArgument val9)
{
    ...
    if (val0.name()
        && (bool) sig.append(val0.name()).append(',')
        && val1.name()
        && (bool) sig.append(val1.name()).append(',')
        && val2.name()
        && (bool) sig.append(val2.name()).append(',')
        && val3.name()
        && (bool) sig.append(val3.name()).append(',')
        && val4.name()
        && (bool) sig.append(val4.name()).append(',')
        && val5.name()
        && (bool) sig.append(val5.name()).append(',')
        && val6.name()
        && (bool) sig.append(val6.name()).append(',')
        && val7.name()
        && (bool) sig.append(val7.name()).append(',')
        && val8.name()
        && (bool) sig.append(val8.name()).append(',')
        && val9.name())
    {
