...
This text describes the algorithms found in the implementation of regular expressions in~Qt~3.0.  We will focus on theory and examples, and mention hastily where to look for the relevant code.
