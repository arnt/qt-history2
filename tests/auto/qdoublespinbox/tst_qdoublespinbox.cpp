...
void tst_QDoubleSpinBox::setPrefixSuffix_data()
{
    ...
    QTest::newRow("data2") << "cm: " << QString() << 10.5 << 0 << "cm: 11" << "11" << false;
    ...
    QTest::newRow("data6") << "cm: " << QString() << 10.5 << 0 << "cm: 11" << "11" << true;
...
void tst_QDoubleSpinBox::setDecimals_data()
{
    ...
    QTest::newRow("data8") << 120 << 13 << -0.12345678901237 << "-0.1234567890124";
