...
/*!
    ...
    number of resources it guards to \a initialValue (by default, 0)
    if the semaphore didn't previously exists.  When initializing the
    key it uses the access mode \a mode.
