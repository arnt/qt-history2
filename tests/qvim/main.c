...
#define EDIT_QF	    4	    /* start in quickfix mode */
    ...
    printf("qvim:always starting gui for Designer\n");
    //## always use gui for Qt/Designer
    gui.starting = TRUE;
...
# endif
    ...
    for (;;)
    {
	printf("qvim:top of main command loop\n");
	if (stuff_empty())
	{
	...
	printf("qvim:main: bottom of loop, skipping command\n");
	break;
	/*
	...
	if (exmode_active)
	    ...
	    normal_cmd(&oa, TRUE);
	//## Don't loop forever (for Qt/Designer)
	break;
    }
    /*NOTREACHED*/
