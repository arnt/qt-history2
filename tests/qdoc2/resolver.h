...
/*
  ...
  Finally, there's a member function 'compare' that hardly belongs here.  It is
  reimplemented in DeclResolver to check whether a piece of documentation has
  changed since the last qdoc run.
*/
class Resolver
{
public:
