/****************************************************************************
** $Id: //depot/qt/main/tests/qtranslator_gui1/ab_centralwidget.cpp#1 $
**
...
void ABCentralWidget::setupTabWidget()
{
    ...
    cFirstName = new QCheckBox( tr( "First &Name" ), search );
    ...
    cLastName = new QCheckBox( tr( "&Last Name" ), search );
    ...
    find = new QPushButton( tr( "&Find" ), search );
...
void ABCentralWidget::setupListView()
{
    ...
    listView->addColumn( tr( "First Name" ) );
    listView->addColumn( tr( "Last Name" ) );
    listView->addColumn( tr( "Address" ) );
    listView->addColumn( tr( "E-Mail" ) );
