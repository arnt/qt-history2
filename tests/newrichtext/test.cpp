...
const char *family = "Sampige,Diwani Letter,Verdana,Latha,Akaash,Serto Jerusalem,Mangal,Rama,TCRC Youtso Unicode,Tahoma"; // Devanagari
...
// const char * s =
// "مرکزکوالیکٹرونک گورنمنٹ دائریکٹریٹ کی طرف سے اردو لوکلائیزیشن پراجیکٹ کے لیے سپانسرشپ ملی "
// ;
