...
void ScriptEngineTamil::shape( ShapedItem *result )
{
//     qDebug("ScriptEngineDevanagari::shape()");
	...
	((OpenTypeIface *) openType)->apply( QFont::Tamil, result, featuresToApply );
	d->isPositioned = TRUE;
    } else {
...
void ScriptEngineTamil::position( ShapedItem *result )
{
