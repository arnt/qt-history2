...
typedef struct tag_SCRIPT_ANALYSIS {
    ...
    WORD    fNoglyph_t   :1;     // Generated by ScriptShape/Place - this item does not use glyph indices
    SCRIPT_STATE s;
} SCRIPT_ANALYSIS;
//
//
...
//              ScriptShape.
//
//p     fNoglyph_t: May be set TRUE on input to ScriptShape to disable use
...
//
//
//p     iCharPos: offset_t from beginning of itemised string to first character
...
HRESULT WINAPI ScriptShape(
    ...
    SCRIPT_ANALYSIS    *psa,            // InOut Result of ScriptItemize (may have fNoglyph_t set)
...
//
//
//      ScriptShape may set the fNoglyph_t flag in psa if the font or
