    ...
    : QDialog(parent, name, TRUE, f)
{
    ...
    setCaption(QString::fromLatin1("QSpinBox test"));
    ...
    */
    ...
    QLabel* stepPre = new QLabel(QString::fromLatin1("Step size:"), this );
    ...
    QLabel* textPre = new QLabel(QString::fromLatin1("Value Text:"), this );
    textPre->setMinimumSize( textPre->sizeHint() );
    QLabel* textLb = new QLabel(QString::fromLatin1("(uninit)"), this );
    ...
    wrapCheck = new QCheckBox(QString::fromLatin1("Enable Wrapping"), this );
    ...
    QLabel* minPre = new QLabel(QString::fromLatin1("Minimum value:"), this );
    ...
    QLabel* maxPre = new QLabel(QString::fromLatin1("Maximum value:"), this );
    ...
    QLabel* valPre = new QLabel(QString::fromLatin1("Set value:"), this );
    ...
    connect( valBox, SIGNAL(valueChanged(int)), 
	     mainBox, SLOT( setValue(int) ) );
    //connect( valBox, SIGNAL(valueChanged(int)), this, SLOT( updateValue(int) ) );


    QLabel* prefixPre = new QLabel(QString::fromLatin1("Set Prefix:"), this );
    prefixPre->setMinimumSize( prefixPre->sizeHint() );
    prefixEd = new QLineEdit( this );
    prefixEd->setMinimumSize( prefixEd->sizeHint() );
    connect( prefixEd, SIGNAL(textChanged(const QString& )), 
	     mainBox, SLOT(setPrefix(const QString&)));

    QLabel* suffixPre = new QLabel(QString::fromLatin1("Set Suffix:"), this );
    suffixPre->setMinimumSize( suffixPre->sizeHint() );
    suffixEd = new QLineEdit( this );
    suffixEd->setMinimumSize( suffixEd->sizeHint() );
    connect( suffixEd, SIGNAL(textChanged(const QString&)), 
	     mainBox, SLOT(setSuffix(const QString&)));

    QLabel* minTxtPre = new QLabel(QString::fromLatin1("Set specialValueText:"), this );
    minTxtPre->setMinimumSize( minTxtPre->sizeHint() );
    minTxtEd = new QLineEdit( this );
    minTxtEd->setMinimumSize( minTxtEd->sizeHint() );
    connect( minTxtEd, SIGNAL(textChanged(const QString&)), 
	     this, SLOT(updateSpecValTxt(const QString&)));

    palCheck = new QCheckBox(QString::fromLatin1("Custom palette"), this );
    palCheck->setMinimumSize( palCheck->sizeHint() );
    connect( palCheck, SIGNAL(clicked()), this, SLOT(updatePalette()) );

    disableCheck = new QCheckBox(QString::fromLatin1("Disabled"), this );
    disableCheck->setMinimumSize( disableCheck->sizeHint() );
    connect( disableCheck, SIGNAL(clicked()), this, SLOT(updateDisabled()) );

    styleCheck = new QCheckBox(QString::fromLatin1("WinStyle"), this );
    styleCheck->setMinimumSize( styleCheck->sizeHint() );
    connect( styleCheck, SIGNAL(clicked()), this, SLOT(updateStyle()) );

    symbolCheck = new QCheckBox(QString::fromLatin1("+/- Symbols"), this );
    ...
    QGridLayout* dl = new QGridLayout( this, 13, 3, 5 );
    ...
    dl->addWidget( styleCheck,	11, 0 );
    dl->addWidget( symbolCheck,	11, 1 );
    dl->addWidget( ok,		12, 2 );
}
...
void Main::updateSymbols()
{
    if ( symbolCheck->isChecked() )
	mainBox->setButtonSymbols( QSpinBox::PlusMinus );
    else
	mainBox->setButtonSymbols( QSpinBox::UpDownArrows );
}
