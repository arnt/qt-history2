...
int main(int, char** )
{
...

  {
    ...
    ASSERT( map2.count() == 10 );
    ASSERT( MyClass::count == 21 );
    cout << "============ " << MyClass::count << endl;
...

  {
    ...
    ASSERT( list.count() == 15 );
    ASSERT( l2.count() == 16 );
    ASSERT( MyClass::count == 33 );

    l2.clear();
    cout << "============ " << MyClass::count << endl;
    ASSERT( list.count() == 15 );
    ASSERT( l2.count() == 0 );
    ASSERT( MyClass::count == 17 );
