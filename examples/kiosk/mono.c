...
void
MonoDitherImage(register unsigned char *lum, unsigned char *cr, unsigned char *cb, register unsigned char *out, int h, int w)
{
  int bit_r2l;
 ...
 */
void
MonoThresholdImage(unsigned char *lum, unsigned char *cr, unsigned char *cb, unsigned char *out, int h, int w)
{
  unsigned char bit;
  unsigned char data;
