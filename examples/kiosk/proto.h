/****************************************************************************
** $Id: //depot/qt/main/examples/kiosk/proto.h#4 $
**
...
/* mono.c */
void MonoDitherImage(unsigned char *lum, unsigned char *cr, unsigned char *cb, register unsigned char *out, int h, int w);
