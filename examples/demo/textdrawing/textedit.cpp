...
void TextEdit::setupFileActions()
{
    ...
    QAction *a;
    a = new QAction( tr( "New" ), QPixmap( "textdrawing/filenew.xpm" ), tr( "&New..." ), CTRL + Key_N, this, "fileNew" );
    connect( a, SIGNAL( activated() ), this, SLOT( fileNew() ) );
    a->addTo( tb );
    a->addTo( menu );
    a = new QAction( tr( "Open" ), QPixmap( "textdrawing/fileopen.xpm" ), tr( "&Open..." ), CTRL + Key_O, this, "fileOpen" );
    connect( a, SIGNAL( activated() ), this, SLOT( fileOpen() ) );
    a->addTo( tb );
    a->addTo( menu );
    menu->insertSeparator();
    a = new QAction( tr( "Save" ), QPixmap( "textdrawing/filesave.xpm" ), tr( "&Save..." ), CTRL + Key_S, this, "fileSave" );
    ...
    a->addTo( menu );
    menu->insertSeparator();
    a = new QAction( tr( "Print" ), QPixmap( "textdrawing/fileprint.xpm" ), tr( "&Print..." ), CTRL + Key_P, this, "filePrint" );
...
void TextEdit::setupEditActions()
{
    ...
    QAction *a;
    a = new QAction( tr( "Undo" ), QPixmap( "textdrawing/editundo.xpm" ), tr( "&Undo" ), CTRL + Key_Z, this, "editUndo" );
    connect( a, SIGNAL( activated() ), this, SLOT( editUndo() ) );
    a->addTo( tb );
    a->addTo( menu );
    a = new QAction( tr( "Redo" ), QPixmap( "textdrawing/editredo.xpm" ), tr( "&Redo" ), CTRL + Key_Y, this, "editRedo" );
    connect( a, SIGNAL( activated() ), this, SLOT( editRedo() ) );
    a->addTo( tb );
    a->addTo( menu );
    menu->insertSeparator();
    a = new QAction( tr( "Cut" ), QPixmap( "textdrawing/editcut.xpm" ), tr( "&Cut" ), CTRL + Key_X, this, "editCut" );
    ...
    a->addTo( tb );
    a->addTo( menu );
    a = new QAction( tr( "Paste" ), QPixmap( "textdrawing/editpaste.xpm" ), tr( "&Paste" ), CTRL + Key_V, this, "editPaste" );
...
void TextEdit::setupTextActions()
{
    ...
    actionTextBold = new QAction( tr( "Bold" ), QPixmap( "textdrawing/textbold.xpm" ), tr( "&Bold" ), CTRL + Key_B, this, "textBold" );
    ...
    actionTextItalic = new QAction( tr( "Italic" ), QPixmap( "textdrawing/textitalic.xpm" ), tr( "&Italic" ), CTRL + Key_I, this, "textItalic" );
    ...
    actionTextUnderline = new QAction( tr( "Underline" ), QPixmap( "textdrawing/textunder.xpm" ), tr( "&Underline" ), CTRL + Key_U, this, "textUnderline" );
    ...
    actionAlignLeft = new QAction( tr( "Left" ), QPixmap( "textdrawing/textleft.xpm" ), tr( "&Left" ), CTRL + Key_L, grp, "textLeft" );
    ...
    actionAlignRight = new QAction( tr( "Right" ), QPixmap( "textdrawing/textright.xpm" ), tr( "&Right" ), CTRL + Key_R, grp, "textRight" );
    actionAlignRight->addTo( tb );
    actionAlignRight->addTo( menu );
    actionAlignRight->setToggleAction( TRUE );
    actionAlignJustify = new QAction( tr( "Justify" ), QPixmap( "textdrawing/textjustify.xpm" ), tr( "&Justify" ), CTRL + Key_J, grp, "textjustify" );
