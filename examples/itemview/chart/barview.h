...
class BarView : public QAbstractItemView
{
    Q_OBJECT
public:
    BarView(QWidget *parent = 0, Qt::Orientation orient = Qt::Vertical);
...
private:
    ...
    int validRows(const QModelIndex &parent = QModelIndex::Null) const;
    bool validValue(const QModelIndex &parent, int row) const;
