...
{
    return QComponentFactory::registerComponent( Component1::cid, filepath, "Qt.Example1", "An example component for Qt" ) &&
	   QComponentFactory::registerComponent( Component2::cid, filepath, "Qt.Example2", "Another example component for Qt" );
}
