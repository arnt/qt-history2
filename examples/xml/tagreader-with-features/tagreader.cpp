...
int main( int argc, char **argv )
{
    ...
    Q3ListView * nameSpace = new Q3ListView( container, "table_namespace" );
    StructureParser * handler = new StructureParser( nameSpace );
    reader.setContentHandler( handler );
    reader.parse( source );

    Q3ListView * namespacePrefix = new Q3ListView( container,
    ...
    Q3ListView * prefix = new Q3ListView( container, "table_prefix");
